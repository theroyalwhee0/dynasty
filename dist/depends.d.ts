 ...
 */
export declare const DEPENDENCY: unique symbol;
/**
 ...
 */
export declare function markDependency<const R>(dependency: UnmarkedDependency<R>): Dependency<R>;
/**
 ...
 */
export declare function isDependency<const R>(value: UnmarkedDependency<R> | R): value is Dependency<R>;
/**
...
export type ResolvableRecord<R extends UnknownRecord> = {
    readonly [P in keyof R]: (Promise<R[P]> | Dependency<R[P]> | R[P]);
};
/**
 * Dependency Record.
...
export type DependencyRecord<T extends ResolvableRecord<R>, R extends UnknownRecord = UnknownRecord> = {
    readonly [K in keyof T]: (T[K] extends Dependency<infer U> ? U : T[K]);
};
/**
 ...
 */
export declare function resolveDependencies<const T extends readonly unknown[]>(dependencies: Dependencies<T>): Promise<T>;
